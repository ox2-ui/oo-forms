...
//       // if (myNode.children.length < 3)
//       //   $node.addClass('instant');
...
Template.ooNativeScroller.events({
  'scroll': function(e, t) {
    var self = this;
    // console.log('%c e scroll  ',  'background: #B3CC57; color: white; padding: 1px 15px 1px 5px;', e);
    if (self.loadMore) {
